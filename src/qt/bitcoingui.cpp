    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Goodmorningnetwork Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Goodmorningnetwork address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Goodmorningnetwork: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Goodmorningnetwork Core"), this);
    aboutAction->setStatusTip(tr("Show information about Goodmorningnetwork Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Goodmorningnetwork Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Goodmorningnetwork addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Goodmorningnetwork addresses"));
    ...
    openAction->setStatusTip(tr("Open a Goodmorningnetwork: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Goodmorningnetwork Core help message to get a list with possible Goodmorningnetwork Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Goodmorningnetwork Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Goodmorningnetwork network", "", count));
    } else {
...
{
    QString strTitle = tr("Goodmorningnetwork Core"); // default title
    ...
    // Append title to "Goodmorningnetwork Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
