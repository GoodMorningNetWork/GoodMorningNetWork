...
// sendGoodmorningnetworkScript just take a QString and executes it as apple script
void MacNotificationHandler::sendGoodmorningnetworkScript(const QString &script)
{
    QByteArray utf8 = script.toUtf8();
    char* cString = (char *)utf8.constData();
    NSString *scriptGoodmorningnetwork = [[NSString alloc] initWithUTF8String:cString];

    NSAppleScript *as = [[NSAppleScript alloc] initWithSource:scriptGoodmorningnetwork];
    NSDictionary *err = nil;
    [as executeAndReturnError:&err];
    [as release];
    [scriptGoodmorningnetwork release];
}
