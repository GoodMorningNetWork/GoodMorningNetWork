    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GM-light"), QVariant("light"));
    ui->theme->addItem(QString("GM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GM-traditional"), QVariant("trad"));
