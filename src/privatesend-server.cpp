...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Goodmorningnetwork related functionality
...
/*
    ...
    allow endless transaction that would bloat Goodmorningnetwork and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("Goodmorningnetwork-ps-server");
