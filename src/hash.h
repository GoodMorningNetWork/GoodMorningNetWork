...
template<typename T1>
inline uint256 Rwahash_cpu(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
...
template<typename T1>
inline uint256 Rwahashv2(const T1 pbegin, const T1 pend, const uint256 PrevBlockHash)
{
    unsigned char hash[128] = { 0 };
    unsigned char hashA[64] = { 0 };
    unsigned char hashB[64] = { 0 };
