...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Goodmorningnetwork Core Goodmorningnetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Goodmorningnetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Goodmorningnetwork transaction") + "\n" +
              "  Goodmorningnetwork-tx [options] -create [commands]   " + _("Create hex-encoded Goodmorningnetwork transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Goodmorningnetwork transaction
