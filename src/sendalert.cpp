...
2. run Goodmorningnetworkd with -printalert or -sendalert like this:
   /path/to/Goodmorningnetworkd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.Goodmorningnetwork.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Goodmorningnetwork Core:0.12.0.58/"));
