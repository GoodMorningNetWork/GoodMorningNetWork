...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GoodmorningnetworkNetwork") type = GoodmorningnetworkNetwork;
    if(strType == "GoodmorningnetworkNetworkVariable") type = GoodmorningnetworkNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GoodmorningnetworkNetwork) s = "GoodmorningnetworkNetwork";
    if(type == GoodmorningnetworkNetworkVariable) s = "GoodmorningnetworkNetworkVariable";
