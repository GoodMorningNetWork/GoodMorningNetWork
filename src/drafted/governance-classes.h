 ...
 *
 *   // network
 *   CGoodmorningnetworkNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.Goodmorningnetwork.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CGoodmorningnetworkNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CGoodmorningnetworkNetwork(UniValue objIn)
    {
...
// // can be under: GoodmorningnetworkNetwork
// //   -- signature requirements : Key1(User)
// class CGoodmorningnetworkNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == GoodmorningnetworkNetwork);
//     // }
